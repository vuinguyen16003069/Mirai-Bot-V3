...
module.exports.languages = {
  vi: {
    ...
    rewarded: 'Điểm danh thành công,bạn đã nhận %1$, để có thể tiếp tục nhận, vui lòng quay lại sau %2 nữa',
  },
};
...
module.exports.run = async ({ event, api, Currencies, getText }) => {
  ...
  return api.sendMessage(getText('rewarded', rewardCoin.toLocaleString(), formatTime(cooldownTime)), threadID);
};
